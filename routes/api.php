...
//    Route::get('/login/{provider}',                 [LoginController::class,'redirectToProvider']);
    ...
    Route::group(['prefix' => 'rest'], function () {
        ...
        /* Tags */
        Route::get('subscriptions',                 [Rest\SubscriptionController::class, 'index']);
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::group(['prefix' => 'user', 'middleware' => ['sanctum.check'], 'as' => 'user.'], function () {
            ...
            /* Seller Subscription */
            Route::get('subscriptions',               [User\SubscriptionController::class, 'index']);
            Route::get('my-subscriptions',            [User\SubscriptionController::class, 'mySubscription']);
            Route::post('subscriptions/{id}/attach',  [User\SubscriptionController::class, 'subscriptionAttach']);
        ...
        Route::group(['prefix' => 'admin', 'middleware' => ['sanctum.check', 'role:admin|manager'], 'as' => 'admin.'], function () {
            ...
            Route::get('customer-subscriptions',		  [Admin\SubscriptionController::class,'customerSubscriptions']);
            Route::get('customer-subscriptions/{id}', 	  [Admin\SubscriptionController::class,'customerSubscriptionShow']);
