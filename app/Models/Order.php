 ...
 * @property float|null $rate_small_order_fee
 ...
 * @property double|null $business_delivery_fee
 ...
 * @property-read double|null $rate_business_delivery_fee
...
class Order extends Model
{
    ...
    {
        if (request()->is('api/v1/dashboard/user/*') || request()->is('api/v1/rest/*')) {
            return $this->business_delivery_fee * ($this->rate <= 0 ? 1 : $this->rate);
        }
    ...
    public function getRateSmallOrderFeeAttribute(): ?float
    {
        if (request()->is('api/v1/dashboard/user/*') || request()->is('api/v1/rest/*')) {
            return $this->small_order_fee * ($this->rate <= 0 ? 1 : $this->rate);
        }
