...
class TransactionService extends CoreService
{
    ...
    public function subscriptionTransaction(int $id, array $data): array
    {
        ...
        return $this->subscription($subscription, $data);
    }

    public function userSubscriptionTransaction(int $id, array $data): array
    {
    ...
    private function subscription($subscription,$data): array
    {
